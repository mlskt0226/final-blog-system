...
| ✅ Роли ADMIN/USER | **Готово** | Права доступа (автор/админ) |
| ✅ Адаптивный дизайн        | **Готово** | Bootstrap responsive        |
| ✅ Фильтрация постов        | **Готово** | По автору user_id           |
| ✅ Автоматическая пагинация | **Готово** | 5 постов на странице        |
| ✅ Logout функционал        | **Готово** | Очистка cookies             |
| ✅ Docker поддержка         | **Готово** | Dockerfile + docker-compose |
| ✅ Тестовое покрытие        | **Готово** | pytest ≥25% github​         |
| ✅Регистрация, аутентификация и страницы регистрации и входа                                   | **Готово** | Полные формы + JWT-like куки, только авторизованные пользователи могут создавать/удалять |
| ✅Страница профиля пользователя с возможностью редактирования информации собственного аккаунта | **Готово** | GET/POST /profile, редактирование username/email                                         |
| ✅Главная страница с лентой постов                                                             | **Готово** | С пагинацией, поиском и комментариями                                                    |
| ✅Страница создания поста                                                                      | **Готово** | Форма POST /posts/ с редиректом                                                          |
| ✅Возможность поиска постов по заголовку и тексту                                              | **Готово** | GET /?q= + API /search/posts/                                                            |
| ✅Возможность сохранять и просматривать избранные посты                                        | **Готово** | /favorites + add/remove кнопки                                                           |
| ✅Валидация данных форм                                                                        | **Готово** | Pydantic + Form(...) + уникальность email                                                |
| ✅Обработка серверных ошибок                                                                   | **Готово** | HTTPException 400/401/404 с понятными сообщениями                                        |
##  Технологии
